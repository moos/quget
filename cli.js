...
var cheerio = require('cheerio'),
  opt = {selectors: true},
  $ = cheerio.load('<div a="1"><p>Im pppp</p><p>another p</p></div><p aa="atr a" class="boo" data="bar" data-foo="data foo">outout p</p>', opt),
  Mark = require("markup-js"),
//  Mark = require("./node_modules/markup-js/src/markup.min.js"),
  numSelectors,
  parsedSelectors,
  selectors = 'foo, div  p ,  p ',
  res = $(selectors),
  a;

CSSwhat(selectors, opt);
parsedSelectors = opt.selectors;
...
//Mark.pipes.html00 = function(obj){
//  return $.html(obj);
//};
//
//Mark.pipes.text = function(obj){
//  return $(obj).text();
//};
